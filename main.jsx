...
(function setupInstallBanner() {
  ...
  function showBanner() {
    ...
    banner.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:#fff;border:3px solid #1e3a8a;border-radius:20px;padding:20px 22px;box-shadow:0 16px 50px rgba(0,0,0,0.35);z-index:99999;display:flex;flex-direction:column;gap:14px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;max-width:440px;width:calc(100% - 24px);animation:slideUp .3s ease;';
    banner.innerHTML = '<div style="display:flex;align-items:center;gap:14px"><div style="font-size:48px;line-height:1">📱</div><div style="flex:1"><div style="font-size:18px;font-weight:900;color:#1e3a8a;line-height:1.2">Instalar TELEMIM no celular</div><div style="font-size:14px;color:#475569;margin-top:6px;line-height:1.3">Acesso rápido, funciona offline e parece app nativo</div></div><button id="pwa-install-no" style="background:transparent;border:none;color:#94a3b8;font-size:28px;cursor:pointer;padding:4px 8px;line-height:1;align-self:flex-start">✕</button></div><div style="display:flex;gap:10px"><button id="pwa-install-yes" style="flex:1;padding:14px 18px;background:linear-gradient(135deg,#7c3aed,#1e3a8a);color:#fff;border:none;border-radius:12px;font-weight:900;font-size:15px;cursor:pointer;box-shadow:0 4px 14px rgba(30,58,138,0.4)">📥 Instalar agora</button></div>';
