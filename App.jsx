...
export default function App(){
  ...
  const TABS=[
    ...
    ...(isAdmin?[{id:"financeiro",label:"💰 Financeiro"},{id:"config",label:"⚙️ Config"}]:[]),
  ];
