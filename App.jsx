          ...
          <Card>
            ...
            <div style={{marginBottom:12}}>
              ...
              <div style={{display:"flex",gap:7}}>
                ...
                {a.requires_validation&&<div style={{display:"flex",gap:4,marginTop:5,flexWrap:"wrap"}}>
                  {a.social_approved
                    ?<span style={{padding:"2px 8px",borderRadius:999,fontSize:10,fontWeight:700,background:"#dcfce7",color:"#15803d"}}>✅ Social</span>
                    :(usuario?.perfil==="social")
                      ?<button onClick={(e)=>{e.stopPropagation();handleValidar3vias(a.id,"social");}} style={{padding:"2px 8px",borderRadius:999,fontSize:10,fontWeight:700,border:"none",background:"#facc15",color:"#713f12",cursor:"pointer"}}>👆 Validar Social</button>
                  ...
                  {a.promorar_approved
                    ...
                    :(usuario?.perfil==="promorar")
                      ?<button onClick={(e)=>{e.stopPropagation();handleValidar3vias(a.id,"promorar");}} style={{padding:"2px 8px",borderRadius:999,fontSize:10,fontWeight:700,border:"none",background:"#facc15",color:"#713f12",cursor:"pointer"}}>👆 Validar Promorar</button>
                  ...
                  {a.adm_approved
                    ...
                    :(usuario?.perfil==="admin"||usuario?.perfil==="telemim")
                      ?<button onClick={(e)=>{e.stopPropagation();handleValidar3vias(a.id,"adm");}} style={{padding:"2px 8px",borderRadius:999,fontSize:10,fontWeight:700,border:"none",background:"#facc15",color:"#713f12",cursor:"pointer"}}>👆 Validar Adm</button>
