import { useState, useEffect } from "react";
    ...
    const{data:ch2}=await supabase.from('contas_pagar').select('*').eq('status','pago').order('pago_em',{ascending:false}).limit(30);
