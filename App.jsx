...
export default function App(){
  ...
  const [targetMoveId,setTargetMoveId]=useState(null);
  ...
  if(!usuario)useEffect(function(){if(!targetMoveId)return;setTimeout(function(){var el=document.getElementById("move-card-"+targetMoveId);if(el)el.scrollIntoView({behavior:"smooth",block:"center"});},250);var t=setTimeout(function(){setTargetMoveId(null);},3000);return function(){clearTimeout(t);};},[targetMoveId]);
          ...
          <div>
            ...
            {proximas.length>0&&(
              <div style={{marginBottom:16}}>
                {proximas.map(a=>(
                  <Card key={a.id} id={"move-card-"+a.id} style={{marginBottom:9,padding:"14px 16px",border:targetMoveId===a.id?"3px solid #f59e0b":`1.5px solid ${statusColor[a.status]||COLORS.cardBorder}33`,transition:"all 0.3s",boxShadow:targetMoveId===a.id?"0 0 0 4px rgba(245,158,11,0.25)":undefined}}>
