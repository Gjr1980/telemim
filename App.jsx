...
export default function App(){
  ...
  async function sincronizarAgenda(){
    ...
    try{
      ...
      setSyncMsg('✅ '+res.sincronizados+' mov(s). '+res.nomes_inseridos);
      await loadMud();
