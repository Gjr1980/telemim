...
export default function App(){
  ...
  const agendaOrdenada=[...agenda].filter(a=>a.status!=='concluida'&&!a.deleted_at&&!_agendaRemovidaIds.has(a.id)).sort((a,b)=>a.data.localeCompare(b.data)||(a.horario||"").localeCompare(b.horario||""));
  ...
  const mudancasHoje=agendaOrdenada.filter(a=>a.data===hoje&&!_statusRealizados.includes(a.status)&&!_jaEmMudancas(a)&&(!isMotorista||a.van));
  const mudancasAmanha=agendaOrdenada.filter(a=>a.data===amanha&&!_statusRealizados.includes(a.status)&&!_jaEmMudancas(a)&&(!isMotorista||a.van));
