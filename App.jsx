...
export default function App(){
  ...
  async function sincronizarAgenda(){
    ...
    try{
      const {data,error}=await supabase.rpc('sincronizar_agenda_nao_realizada');
      if(error) throw error;
      var res=data&&data[0]?data[0]:{sincronizados:0,nomes_inseridos:'Nenhum'};
      setSyncMsg('✅ '+res.sincronizados+' mov(s) sincronizado(s). '+res.nomes_inseridos);
      await loadMud();
