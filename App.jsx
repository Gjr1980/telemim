...
export default function App(){
  ...
  useEffect(function(){if(prestadores.length===0)loadPrestadores();if(isAdmin&&listaUsuarios.length===0&&(tab==="agenda"||tab==="lista"))carregarUsuarios();},[tab]);
  useEffect(()=>{
    async function load(){
      try{
              ...
              <div key={a.id} style={{background:"#dcfce7",border:(_dest?"3px":"2px")+" solid #16a34a",borderRadius:_dest?18:14,padding:_dest?"20px 18px":"14px 15px",boxShadow:_dest?"0 4px 16px rgba(22,163,74,0.25)":"0 2px 8px rgba(22,163,74,0.15)"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:_dest?14:10}}>
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:_dest?13:11,marginTop:4}}>📦 {a.origem?<a href={"https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(a.origem)} target="_blank" style={{color:"#2563eb",textDecoration:"none",fontWeight:600}}>{a.origem} 🗺️</a>:<span style={{color:"#64748b"}}>?</span>}</div>
                    <div style={{fontSize:_dest?13:11,marginTop:6}}>🏘️ {a.destino?<a href={"https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(a.destino)} target="_blank" style={{color:"#2563eb",textDecoration:"none",fontWeight:600}}>{a.destino} 🗺️</a>:<span style={{color:"#64748b"}}>?</span>}</div>
                  </div>
              ...
              <div key={a.id} style={{background:"#fff7ed",border:"2px solid #f97316",borderRadius:14,padding:"14px 15px",boxShadow:"0 2px 8px rgba(249,115,22,0.15)"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:11,marginTop:4}}>📦 {a.origem?<a href={"https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(a.origem)} target="_blank" style={{color:"#2563eb",textDecoration:"none",fontWeight:600}}>{a.origem} 🗺️</a>:<span style={{color:"#64748b"}}>?</span>}</div>
                    <div style={{fontSize:11,marginTop:6}}>🏘️ {a.destino?<a href={"https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(a.destino)} target="_blank" style={{color:"#2563eb",textDecoration:"none",fontWeight:600}}>{a.destino} 🗺️</a>:<span style={{color:"#64748b"}}>?</span>}</div>
                  </div>
