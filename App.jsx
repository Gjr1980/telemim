...
export default function App(){
  ...
  useEffect(function(){var el=document.getElementById("cdm");if(el) el.style.display=confirmDelete?"flex":"none";if(!confirmDelete||el) return;var ov=document.createElement("div");ov.id="cdm";ov.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.55);z-index:9998;display:flex;align-items:center;justify-content:center;padding:16px";ov.onclick=function(e){if(e.target===ov)setConfirmDelete(null);};var box=document.createElement("div");box.style.cssText="background:#fff;border-radius:20px;padding:28px 24px;max-width:340px;width:100%;box-shadow:0 8px 40px rgba(0,0,0,.2);text-align:center";var ico=document.createElement("div");ico.style.cssText="font-size:36px;margin-bottom:12px";ico.textContent="⚠️";var title=document.createElement("div");title.style.cssText="font-weight:800;font-size:16px;color:#1e293b;margin-bottom:8px";title.textContent="Tem a certeza?";var sub=document.createElement("div");sub.style.cssText="font-size:13px;color:#64748b;margin-bottom:20px";sub.textContent="Apagar?";var btns=document.createElement("div");btns.style.cssText="display:flex;gap:10px";var bNo=document.createElement("button");bNo.style.cssText="flex:1;padding:11px 0;border-radius:12px;border:1.5px solid #e2e8f0;background:#f8fafc;color:#64748b;font-weight:700;font-size:13px;cursor:pointer";bNo.textContent="Cancelar";bNo.onclick=function(){setConfirmDelete(null);};var bYes=document.createElement("button");bYes.style.cssText="flex:1;padding:11px 0;border-radius:12px;border:none;background:#ef4444;color:#fff;font-weight:800;font-size:13px;cursor:pointer";bYes.textContent="🗑️ Sim, Apagar";bYes.onclick=function(){if(confirmDelete.tipo==="mud")handleDelMud(confirmDelete.id);else handleDelAg(confirmDelete.id);setConfirmDelete(null);};btns.appendChild(bNo);btns.appendChild(bYes);box.appendChild(ico);box.appendChild(title);box.appendChild(sub);box.appendChild(btns);ov.appendChild(box);document.body.appendChild(ov);return function(){var x=document.getElementById("cdm");if(x&&x.parentNode)x.parentNode.removeChild(x);};},[confirmDelete]);
