              ...
              <div key={a.id} style={{background:"#dcfce7",border:(_dest?"3px":"2px")+" solid #16a34a",borderRadius:_dest?18:14,padding:_dest?"20px 18px":"14px 15px",boxShadow:_dest?"0 4px 16px rgba(22,163,74,0.25)":"0 2px 8px rgba(22,163,74,0.15)"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:_dest?14:10}}>
                  <div style={{flex:1}}>
                    ...
                    {a.approved_by_supervisor&&<div style={{fontSize:_dest?13:12,marginTop:8,fontWeight:700,color:"#065f46",background:"#ecfdf5",borderRadius:8,padding:"5px 10px",border:"1px solid #a7f3d0"}}>👷 Supervisor: {a.approved_by_supervisor}</div>}
                  </div>
              ...
              <div key={a.id} style={{background:"#fff7ed",border:"2px solid #f97316",borderRadius:14,padding:"14px 15px",boxShadow:"0 2px 8px rgba(249,115,22,0.15)"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
                  <div style={{flex:1}}>
                    ...
                    {a.approved_by_supervisor&&<div style={{fontSize:12,marginTop:8,fontWeight:700,color:"#065f46",background:"#ecfdf5",borderRadius:8,padding:"5px 10px",border:"1px solid #a7f3d0"}}>👷 Supervisor: {a.approved_by_supervisor}</div>}
                  </div>
